const skillsMap = [
  ...
  {
    CultistaArrependido: ["Ocultismo", "Religião"],
  },
  {
  ...
  {
    ServidorPúblico: ["Intuição", "Vontade"],
  },
  {
    TeóricodaConspiração: ["Investigação", "Ocultismo"],
  },
  {
    TI: ["Investigação", "Tecnologia"],
  },
  {
    TrabalhadorRural: ["Adestramento", "Sobrevivência"],
  },
  {
